...
function DocsPage() {
  ...
  "payment_url": "${BASE}/pay/PRINCESOFTTECH-1234567890",
  "upi_uri": "upi://pay?pa=...&am=100.07&cu=INR&tn=PRINCESOFTTECH-1234567890",
...
export async function POST(req: Request) {
  ...
  return new Response("ok", { status: 200 });
            ...
            <Section id="verify-payment" title="Verify a Payment">
              ...
              <CodeBlock title="Request" lang="bash">
                {`curl ${BASE}/api/public/v1/orders/PRINCESOFTTECH-1234567890 \\
  -H "Authorization: Bearer <YOUR_API_KEY>"`}
              </CodeBlock>
